...
```{python}
#| label: 02-boxplot-by-species
#| fig-cap: "Iris — Petal Length by Species (Boxplot Only)"
...
```{python}
#| label: 02-boxplot-with-points-by-species
#| fig-cap: "Iris — Petal Length by Species (Boxplot with Observed Points)"
