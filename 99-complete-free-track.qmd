...
- deployed into real environments  
- monitored as new data arrives  
- improved over time  

This is how analytical work becomes a real-world system.
...
- **Deployment** → making models usable in real systems  
- **DevOps / MLOps** → maintaining and improving systems over time  
...
- begin building systems that operate beyond a single dataset  
